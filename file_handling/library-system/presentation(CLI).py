...
from repositories import InMemoryLoanRepository, InMemoryMemberRepository, InMemoryBookRepository, TextFileBookRepository, TextFileMemberRepository, TextFileLoanRepository
from service import LibraryService, LibraryError

library_service = LibraryService(books= TextFileBookRepository(), members= TextFileMemberRepository(), loans= TextFileLoanRepository())
